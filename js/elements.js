export const modalProduct                  = document.querySelector('.modal__product');
...
export const modalProductImg               = document.querySelector('.modal-product__img');
...
export const ingredientsColories           = document.querySelector('.ingredients__calories');
